var hexagon = {
    bg_default_color: '#272727',
    value_default_color: '#ffe400',
    x_offset: 30,
    ...
    init: function(id, side_length, names, color) {
        ...
        hexagoncontext.fill();
        hexagoncontext.fillText(names[0], width / 2 + S / 2 + 5, 10);
        ...
        hexagoncontext.fillText(names[4], 0, height * 3 / 4 + 12);
        hexagoncontext.fillText(names[5], 0, height / 4 - 14);
    },
